...
export default function page() {
  ...
  return (
    <section className="h-[90vh] w-screen flex justify-around items-center ">
      <h1 className="absolute top-30 text-2xl text-white font-semibold">Featured  <span className="text-[#aa00ff] ">Projects</span></h1>
      {Projects.map((project) => (
        ...
        >
          <figure className="grid grid-cols-1 text-center h-full rounded-lg place-items-end    ">
            ...
            />
            <figcaption className="h-[7.5rem] col-start-1 col-end-1 row-start-1 row-end-1  w-full rounded-b-lg Decription flex flex-col justify-center pl-4 items-start text-center text-white">
