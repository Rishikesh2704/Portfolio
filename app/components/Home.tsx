...
export default function Home() {
  ...
  return (
    <div className="h-[95%] w-[95vw] max-md:h-[78%] grid grid-cols-2 grid-rows-2 max-sm:grid-cols-1 max-sm:grid-rows-3 place-content-center justify-center md:place-items-center z-1  text-white">
      <section className="CardBg max-sm:p-[0.8rem] h-[31vmin] w-[80vmin] max-sm:w-[80vw] max-sm:h-[12vh] font-semibold max-lg:w-[45vmin] max-lg:h-[22vmin]  bg-[rgba(255, 255, 255, 0.8)] backdrop-blur-3xl flex flex-col  text-start pl-2 justify-center items-start text-white col-start-1 row-start-1 rounded-lg   ">
      ...
      <section className="CardBg h-[65%] w-[70%] max-sm:h-[55%] max-lg:w-[80%] max-lg:h-[40%] font-semibold max-sm:row-start-3 relative flex flex-col gap-1 text-start pl-2 justify-center text-[#e3e1e1] rounded-lg ">
        ...
        <div className="flex flex-col gap-1 text-[2.1 vmin] max-sm:text-[2.7vmin]">
          <span className="text-[2.9vmin] max-sm:text-[1.2vmax] max-lg:text-[1.8vmin] [word-spacing:-0.2rem] text-white">
      ...
      <section className="CardBg h-[75%] w-[90%] max-sm:w-[80%] max-sm:h-[65%] relative flex flex-col col-start-1 col-end-3  text-start pl-2 justify-center text-white  rounded-lg ">
