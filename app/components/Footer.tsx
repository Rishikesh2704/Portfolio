    ...
    <footer className="absolute right-8 bottom-3 w-fit h-fit  flex gap-4">
      {Icons.map((icon) => (
        <Link
          ...
          className="Btns h-[2rem] w-[2rem] flex items-center justify-center rounded-md text-gray-200 hover:scale-110 duration-200 ease-out hover:shadow-[0px_0px_10px_#c581e7] "
        >
