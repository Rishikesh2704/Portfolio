      ...
      <fieldset className="relative w-fit h-full flex  items-center justify-center ">
        {navLinks.map((li, idx) => (
          <Link
            ...
            className={`w-[8rem] active:text-[#e3e1e1] text-[#888686] z-1 font-[550] p-[0.4rem_2.2rem] flex items-center justify-center cursor-pointer ${path === li.path.split("/")[1] ? "text-[#f1efef]" : "text-[#888686]"}`}
          >
            {li.name}
          </Link>
        ))}
